        ...
        <div class="form-container mx-8">
            <form action="register_process.php" method="post">
                ...
                <div class="form-label mb-2" style="color: black;">
                    Jenis Kelamin
                    <div class="dropdown">
                        <a class="btn btn-secondary border-0 py-2" name="jenis_kelamin" style="background-color: white; color: black" id="jenis_kelamin">Jenis Kelamin</a>
                        <button class="btn btn-secondary dropdown-toggle py-2" type="button" id="dropdownMenuButtonJeniskelamin" data-bs-toggle="dropdown" aria-expanded="false"></button>
                        <ul class="dropdown-menu dropdown-menu-level" aria-labelledby="dropdownMenuButtonLevel">
                            <li class="btn dropdown-item jenis_kelamin" data-value="pria">Pria</li>
                            <li class="btn dropdown-item jenis_kelamin" data-value="wanita">Wanita</li>
                        </ul>
                        <input type="hidden" name="jenis_kelamin" id="selectedJenisKelamin" required>
                    </div>
                </div>
                <div class="mb-2" style="color: black;">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-level" aria-labelledby="dropdownMenuButtonLevel">
                            <li class="btn dropdown-item level" data-value="anggota">Anggota</li>
                            <li class="btn dropdown-item level" data-value="pembina">Pembina</li>
                        </ul>
...
<script>
    ...
    const dropdownButtonLevel = document.getElementById('levelButton');
    ...
    dropdownItemsLevel.forEach(item => {
        item.addEventListener('click', function() {
            ...
            dropdownButtonLevel.textContent = this.textContent;
        });
    });
    const dropdownItemsJenisKelamin = document.querySelectorAll('.jenis_kelamin');
    const dropdownButtonJenisKelamin = document.getElementById('jenis_kelamin');
    const selectedJenisKelaminInput = document.getElementById('selectedJenisKelamin');

    dropdownItemsJenisKelamin.forEach(item => {
        item.addEventListener('click', function() {
            const selectedValue = this.getAttribute('data-value');
            selectedJenisKelaminInput.value = selectedValue;
            dropdownButtonJenisKelamin.textContent = this.textContent;
        });
    });
</script>
</body>
