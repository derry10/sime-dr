                    ...
                    <tr>
                      ...
                      <td>
                        <div class="container d-flex justify-content-center align-items-center">
                          <a href="absensi.php?kegiatan_id=<?= $item['id'] ?>" type="button" class="btn btn-primary px-4 mx-3" style="background-color: #0094FF;">Detail</a>
                        </div>
                      </td>
                      <td>
                        <div class="container d-flex justify-content-center align-items-center">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    ubahKegiatanModal.addEventListener('show.bs.modal', function (event) {
        ...
        var minggu = button.getAttribute('data-minggu');
        var tanggal = button.getAttribute('data-tanggal');
        var deskripsi = button.getAttribute('data-deskripsi');

        var modalId = ubahKegiatanModal.querySelector('#ubahId');
        var modalNama = ubahKegiatanModal.querySelector('#ubahNama');
        var modalMinggu = ubahKegiatanModal.querySelector('#ubahMinggu');
        var modalTanggal = ubahKegiatanModal.querySelector('#ubahTanggal');
        var modalDeskripsi = ubahKegiatanModal.querySelector('#ubahDeskripsi');

        modalId.value = id;
        modalNama.value = nama;
        modalMinggu.value = minggu;
