 ...
 <div class="sidebar collapse d-md-block" id="sidebarMenu">
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item d-flex align-items-center mx-2">
                <a class="btn btn-outline-secondary border-0 mx-3 dropdown-toggle text-white" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../img/ekskul.png" alt="Reports" width="28" height="28"> Ekstrakulikuler
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="create_ekskul.php">Buat Ekskul Baru</a></li>
